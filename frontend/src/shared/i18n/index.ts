  ...
  "zh-CN": {
    translation: {
      ...
      statusReauthRequired: "失效",
        ...
        totalUsage: "总用量 {{requests}} 次 · {{tokens}} tokens · {{cost}}",
        batchHealthProbed: "批量测活完成：成功 {{succeeded}}，失败 {{failed}}，跳过 {{skipped}}",
        healthProbeTitle: "批量测活",
        healthProbeDescription: "对已选 {{count}} 个 Grok Build 账号发送最小 Responses 探测（内容为 hi）。通过的账号会同步额度；凭据/权限失败会标记为失效；额度耗尽只记待重置；限流或 5xx 仅短冷却。",
        healthProbeModel: "目标测试模型",
        healthProbeModelHelp: "请选择上游模型；测活会消耗少量额度。",
        healthProbeWarning: "注意：仅凭据无效或权限拒绝会标记为「失效」。额度耗尽不会标失效；上游 5xx/限流只会短冷却。",
        healthProbeStart: "开始测活",
        healthProbeNeedSelection: "请先选择要测活的账号",
        healthProbeNeedModel: "请选择目标测试模型",
        healthProbeBuildOnly: "批量测活目前仅支持 Grok Build 账号",
  ...
  en: {
    translation: {
      ...
      accountCredential: {
        ...
        healthProbeAction: "Health probe",
