  ...
  "zh-CN": {
    translation: {
      ...
      keys: {
        ...
        modelAliases: "模型别名",
        modelAliasesDescription: "开启后，/v1/models 会展开思考等级后缀别名（如 grok-4.5-low、grok-4.3-none），且仅该密钥可使用这些别名。等级严格按各模型真实支持范围展开，不会套用完整 none/low/medium/high/xhigh/max 模板。",
        modelAliasesOn: "已开启：可拉取并调用思考等级后缀别名。",
        modelAliasesOff: "已关闭：仅暴露基础模型名（如 grok-4.5）。",
        allModels: "全部模型",
