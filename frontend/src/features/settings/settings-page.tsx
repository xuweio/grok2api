        ...
        <Tabs defaultValue="build" className="flex flex-col gap-7 lg:flex-row lg:items-start">
          ...
          <SettingsSection title={t("settings.batch.title")}>
            <div className="space-y-0">
              ...
              <SettingsField controlId="batch-probe-concurrency" label={t("settings.batch.probeConcurrency")} description={t("settings.batch.probeConcurrencyHelp")} error={form.formState.errors.batch?.probeConcurrency?.message}><Input id="batch-probe-concurrency" type="number" min={1} max={50} {...form.register("batch.probeConcurrency", { valueAsNumber: true })} /></SettingsField>
